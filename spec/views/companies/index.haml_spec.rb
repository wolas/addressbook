...
describe "/companies/index.haml" do
  before do
    ...
    company_98.should_receive(:city).and_return("MyString")
    company_98.should_receive(:street).and_return("MyString")
    company_99 = mock_model(Company)
    company_99.should_receive(:name).and_return("MyString")
    company_99.should_receive(:city).and_return("MyString")
    company_99.should_receive(:street).and_return("MyString")
